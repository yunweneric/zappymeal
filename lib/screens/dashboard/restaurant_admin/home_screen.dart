...
class RestaurantAdminHome extends StatefulWidget {
  const RestaurantAdminHome({super.key});

  @override
  State<RestaurantAdminHome> createState() => _RestaurantAdminHomeState();
}

class _RestaurantAdminHomeState extends State<RestaurantAdminHome> {
  fetchAdminCounter() {
    BlocProvider.of<CounterCubit>(context).getRestaurantAdminCount(context);
  }
